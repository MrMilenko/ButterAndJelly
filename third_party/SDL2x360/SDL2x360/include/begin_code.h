...
#ifndef DECLSPEC
# if defined(__WIN32__) || defined(__WINRT__) || defined(__CYGWIN__) || defined(__GDK__) || defined(__XBOX_360__)
#  ifdef DLL_EXPORT
...
#ifndef SDLCALL
#if (defined(__WIN32__) || defined(__WINRT__) || defined(__XBOX_360__) || defined(__GDK__)) && !defined(__GNUC__)
