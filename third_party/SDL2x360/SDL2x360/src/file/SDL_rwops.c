...
#if defined(HAVE_STDIO_H) && defined(SDL_PLATFORM_XBOX_RXDK) || defined(SDL_PLATFORM_XBOX_360) 
...
#if defined(HAVE_STDIO_H) && !(defined(__WIN32__) || defined(__GDK__) || defined(SDL_PLATFORM_XBOX_RXDK) || defined(SDL_PLATFORM_XBOX_360))
