...
#if defined(__XBOX__) || defined(__XBOX_360__)
    /* Force fullscreen on OG Xbox and Xbox 360, windowing isn’t supported */
...
{
#if defined(__XBOX__) || defined(__XBOX_360__)
    /* No window icon support on original Xbox and Xbox 360. */
    (void)icon; (void)mask;
    return;
#else
